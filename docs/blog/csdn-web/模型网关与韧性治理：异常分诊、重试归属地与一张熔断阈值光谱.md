...
![熔断阈值光谱：模型级 5 次、工具级 3 次、RAG 与画像读路径 1 次——按兜底质量与误熔断代价选型](https://raw.githubusercontent.com/Gavincui123/Agentdemo007/master/docs/blog/assets/2026-09-21-breaker-threshold-spectrum.png)
