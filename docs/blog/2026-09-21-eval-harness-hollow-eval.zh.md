...
> **语言 / Language**：中文 ｜ 系列第九章（[目录](./README.md)）｜ 上一章：[全链路延迟与稳定性调优](./2026-09-16-agent-latency-stability-tuning.zh.md)
>
...
![评测黄金集组成：默认套件 9 个 stage 63 例的分布](assets/2026-09-21-eval-suite-composition.png)
...
*本文机制出处：`eval/`（EvalExpected / EvalExecutor / EvalJobManager / EvalContentResolver / EvalController）；黄金集资源 `src/main/resources/eval/*.json`（15 个 stage 文件）；缺陷清单全文见 [2026-09-19 拒答+录入报告 §7](../reports/2026-09-19-refusal-kb-ingest-report.md)。*

> 相关阅读：[系列目录](./README.md) · [第六章·eval 封锁与闸口](./2026-09-18-decision-arbiter-hitl-l2-access-gate.zh.md) · [第五章·strict 模式故障误报缺陷](./2026-09-21-rag-evolution-abac-refusal.zh.md) · [下一章：前端与流式交互](./2026-09-21-frontend-streaming-ux.zh.md)
