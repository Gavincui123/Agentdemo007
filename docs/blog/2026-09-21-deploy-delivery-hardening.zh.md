...
> **语言 / Language**：中文 ｜ 系列第十二章（完结篇）（[目录](./README.md)）｜ 上一章：[可观测性与审计](./2026-09-21-observability-audit-trace.zh.md)
>
...
> **验证规模**：15+ 个真实部署问题的现象→根因→修复（完整手册见[部署实录](../guides/部署实录.md)，本章是叙事版）
...
![部署拓扑：nginx 反代与 8077 直连双通道，闸口在应用内部守门](assets/2026-09-21-deploy-topology.png)
...
首次公网发布前的安全清单（以部署实录 §7 为主，综合 DEPLOY.md 发布清单与[第六章](./2026-09-18-decision-arbiter-hitl-l2-access-gate.zh.md)的取 IP 修复链，逐条可执行）：
...
3. **双源提示词与本地默认无 diff 校验**（[第二章](./2026-09-21-prompt-engineering-system.zh.md)同条）。
...
> 相关阅读：[系列目录](./README.md) · [上一章：可观测性与审计](./2026-09-21-observability-audit-trace.zh.md) · [第六章·闸口旋钮的设计裁决](./2026-09-18-decision-arbiter-hitl-l2-access-gate.zh.md) · [部署实录（番外·操作手册）](../guides/部署实录.md) —— **系列完**
